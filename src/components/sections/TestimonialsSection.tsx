...
const testimonials = [
  {
    ...
    testimonial:
      'Maarifa AI has revolutionized how we teach Olympic values in our PE classes. The interactive resources and AI-powered recommendations have made a huge difference in student engagement.',
  ...
  },
  {
    ...
    testimonial:
      'Through Maarifa AI, our students have connected with peers worldwide, sharing their Olympic journey and learning from different cultures and perspectives.',
    author: 'Maria Garcia',
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
            Hear from educators around the world who are using Maarifa AI to bring Olympic values to
